...
//    @FXML
    private void goToChoice() throws IOException {
        DBClass db = CPCS405_PROJECT.getDB();
        changePage("ChoicePage.fxml");
...
//        comp.setText(comp.getText() + ": " + db.countScoreOfGameByID(id+"", 2));
    ...
    public void getScore() throws IOException{
        ...
        DBClass db = CPCS405_PROJECT.getDB();
        alert("Your Score in Dyscalculia is: "+db.countScoreOfGameByID(id+"", 1)
        +"\nYour Score in Number Comparsion is: "+db.countScoreOfGameByID(id+"", 2));
    }
}
